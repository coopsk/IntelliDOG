...
public class GameWindow extends JFrame{
	...
	private static final String resPath = "/resources/";
	...
	public GameWindow(String[] playerNames, boolean isForSituationCreation){
	...
	private class ImagePanel extends JPanel {
		...
		public ImagePanel(String img) {
			...
			URL imgURL = getClass().getResource(img);
			ImageIcon icon = new ImageIcon(imgURL, "");
			setImage(icon.getImage());

			Object obj = this.getClass().getResource("/resources/board.png");
