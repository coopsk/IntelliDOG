...
public class BotBoard {
	...
	public List<Move> getPossibleMovesForCard(int card, byte playerOnTurn){
		...
		else if( card == 100) { // Joker
			return getPossibleMovesForJokerOptimized(playerToMoveWith, new boolean[13]);
		}
		assert(card != Cards.JOKER );   //when having a joker it should've been caught before to use the optimized method...
